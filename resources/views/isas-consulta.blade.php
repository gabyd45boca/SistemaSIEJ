...
@section('content_header')
    <h1 class="m-0 text-dark">Consultas Isas</h1>
@stop
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas1->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas2->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas3->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas4->count()}}</span>
            </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas5->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas6->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas7->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas8->count()}}</span>
            </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas9->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas10->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas11->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$isas12->count()}}</span>
            </div>
            </div>
        </div>
...
<hr class="my-4 mx-n4" />
    ...
    <div class="container">
        <h2 class="m-0 text-dark">Isas por Motivo</h2>
