                        ...
                        <x-adminlte-select2 name="nombre_mot[]" id="nombre_mot" class="form-control" title="Seleccionar motivos" multiple required data-placeholder="Seleccionar motivos" data-allow-clear="true">
                            @foreach ($motivos as $motivo)
                                <option value="{{$motivo->id}}" 
                                    {{ in_array($motivo->id, old('nombre_mot', $sumarisima->motivos->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{$motivo->nombre_mot}}
                                </option>
                            @endforeach
                        </x-adminlte-select2>
                        ...
                        <x-adminlte-select2 name="apellido_nombre_inf[]" id="apellido_nombre_inf" class="form-control" title="Seleccionar Infractores" multiple required data-tags="true" data-token-separators="[',']" data-allow-clear="true" data-placeholder="Seleccionar Infractores">
                            @foreach ($infractores as $infractor)
                                <option value="{{$infractor->id}}" 
                                    {{ in_array($infractor->id, old('apellido_nombre_inf', $sumarisima->infractors->pluck('id')->toArray())) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 select2-primary">
                          ...
                          <x-adminlte-select2 name="jerarquia_DGAJ" class="select2 form-select">
                              ...
                              @foreach($jerarquias as $jerarquia)
                                  <option value="{{ $jerarquia->nombre_jer }}" @if ($sumarisima->jerarquia_DGAJ == $jerarquia->nombre_jer) selected @endif>
              ...
              <div class="row g-3">
                        ...
                        <div class="col-md-6 select2-primary">
                          ...
                          <x-adminlte-select2 name="jerarquia_AL" class="select2 form-select">
                              <option value="">Seleccionar la jerarquía</option>
                              @foreach($jerarquias as $jerarquia)
                                  <option value="{{ $jerarquia->nombre_jer }}" @if ($sumarisima->jerarquia_AL == $jerarquia->nombre_jer) selected @endif>
                                      {{ $jerarquia->nombre_jer }}
                                  </option>
                              @endforeach
                          </x-adminlte-select2>
          ...
          <div class="row g-3">
                    ...
                    <div class="col-md-6 select2-primary">
                      ...
                      <x-adminlte-select2 name="jerarquia_SS" class="select2 form-select">
                          <option value="">Seleccionar la jerarquía</option>
                          @foreach($jerarquias as $jerarquia)
                              <option value="{{ $jerarquia->nombre_jer }}" @if ($sumarisima->jerarquia_SS == $jerarquia->nombre_jer) selected @endif>
                                  {{ $jerarquia->nombre_jer }}
                              </option>
                          @endforeach
                      </x-adminlte-select2>
              ...
              <div class="row g-3">
                    ...
                    <div class="col-md-6 select2-primary">
                      ...
                      <x-adminlte-select2 name="jerarquia_DGRRHH" class="select2 form-select">
                          <option value="">Seleccionar la jerarquía</option>
                          @foreach($jerarquias as $jerarquia)
                              <option value="{{ $jerarquia->nombre_jer }}" @if ($sumarisima->jerarquia_DGRRHH == $jerarquia->nombre_jer) selected @endif>
                                  {{ $jerarquia->nombre_jer }}
                              </option>
                          @endforeach
                      </x-adminlte-select2>
