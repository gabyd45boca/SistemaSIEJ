       ...
       @csrf
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="apellido_nombre_inf" id="multicol-apellido_nombre_inf" class="form-control" value="{{old('apellido_nombre_inf')}}" placeholder="Escribir el apellido y nombre"/>
            </div>
