            ...
            <div class="table-responsive text-nowrap">
              ...
              <br>                  
                    ...
                    <div class="col-md-6">
                        ...
                        <x-adminlte-select2 name="tipo_denuncia" required>
                            ...
                            @foreach($tipo_denuncias as $tipo_denuncia)
                                <option value="{{ $tipo_denuncia->nombre_tipoDen }}" {{ $sanciones->tipo_denuncia == $tipo_denuncia->nombre_tipoDen ? 'selected' : '' }}>
                        ...
                        <x-adminlte-select2 name="nombre_mot[]" id="nombre_mot" class="form-control" title="Seleccionar motivos" multiple required data-placeholder="Seleccionar motivos" data-allow-clear="true">
                            @foreach ($motivos as $motivo)
                                <option value="{{$motivo->id}}" 
                                    {{ in_array($motivo->id, old('nombre_mot', $sanciones->motivos->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{$motivo->nombre_mot}}
                                </option>
                            @endforeach
                        </x-adminlte-select2>
                  ...
                  <div class="col-md-12">
                      ...
                      <x-adminlte-select2 name="apellido_inf[]" id="apellido_nombre_inf" class="form-control" title="Seleccionar Infractores" multiple required data-tags="true" data-token-separators="[',']" data-allow-clear="true" data-placeholder="Seleccionar Infractores">
                          @foreach ($infractores as $infractor)
                              <option value="{{$infractor->id}}" 
                                  {{ in_array($infractor->id, old('apellido_nombre_inf', $sanciones->infractors->pluck('id')->toArray())) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 select2-primary">
                          ...
                          <x-adminlte-select2 name="jerarquia_DGAJ" class="select2 form-select">
                              ...
                              @foreach($jerarquias as $jerarquia)
                                  <option value="{{ $jerarquia->nombre_jer }}" @if ($sanciones->jerarquia_DGAJ == $jerarquia->nombre_jer) selected @endif>
              ...
              <div class="row g-3">
                        ...
                        <div class="col-md-6 select2-primary">
                          ...
                          <x-adminlte-select2 name="jerarquia_AL" class="select2 form-select">
                              <option value="">Seleccionar la jerarquía</option>
                              @foreach($jerarquias as $jerarquia)
                                  <option value="{{ $jerarquia->nombre_jer }}" @if ($sanciones->jerarquia_AL == $jerarquia->nombre_jer) selected @endif>
                                      {{ $jerarquia->nombre_jer }}
                                  </option>
                              @endforeach
                          </x-adminlte-select2>
          ...
          <div class="row g-3">
                    ...
                    <div class="col-md-6 select2-primary">
                      ...
                      <x-adminlte-select2 name="jerarquia_SS" class="select2 form-select">
                          <option value="">Seleccionar la jerarquía</option>
                          @foreach($jerarquias as $jerarquia)
                              <option value="{{ $jerarquia->nombre_jer }}" @if ($sanciones->jerarquia_SS == $jerarquia->nombre_jer) selected @endif>
                                  {{ $jerarquia->nombre_jer }}
                              </option>
                          @endforeach
                      </x-adminlte-select2>
              ...
              <div class="row g-3">
                    ...
                    <div class="col-md-6 select2-primary">
                      ...
                      <x-adminlte-select2 name="jerarquia_DGRRHH" class="select2 form-select">
                          <option value="">Seleccionar la jerarquía</option>
                          @foreach($jerarquias as $jerarquia)
                              <option value="{{ $jerarquia->nombre_jer }}" @if ($sanciones->jerarquia_DGRRHH == $jerarquia->nombre_jer) selected @endif>
                                  {{ $jerarquia->nombre_jer }}
                              </option>
                          @endforeach
                      </x-adminlte-select2>
