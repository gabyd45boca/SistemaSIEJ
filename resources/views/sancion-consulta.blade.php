...
@section('content_header')
    <h1 class="m-0 text-dark">Consultas Sanciones</h1>
@stop
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion1->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion2->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion3->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion4->count()}}</span>
            </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion5->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion6->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion7->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion8->count()}}</span>
            </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion9->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion10->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion11->count()}}</span>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$sancion12->count()}}</span>
            </div>
            </div>
        </div>
...
<hr class="my-4 mx-n4" />
    ...
    <div class="container">
        <h2 class="m-0 text-dark">Sanciones por Motivo</h2>
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            fetch("{{ route('sancion.motivosData') }}")
                ...
                .then(data => {
                    ...
                    const counts = data.map(item => item.total);//Extrae el total de sanciones por motivo (total) 
